...
class TestKeyValidation:
    ...
    def test_empty_key(self):
        ...
        assert "empty" in str(exc_info.value).lower() or "32 bytes" in str(exc_info.value)
...
class TestEncryptionDecryption:
    ...
    def test_encrypt_decrypt_roundtrip(self, encryption_service: CredentialEncryptionService):
    ...
    def test_encrypt_empty_string(self, encryption_service: CredentialEncryptionService):
    ...
    def test_decrypt_invalid_token(self, encryption_service: CredentialEncryptionService):
        ...
        assert "decrypt" in str(exc_info.value).lower() or "invalid" in str(exc_info.value).lower()

    def test_decrypt_tampered_token(self, encryption_service: CredentialEncryptionService):
...
class TestSecurityRequirements:
    ...
    def test_encrypted_output_not_equal_plaintext(self, encryption_service: CredentialEncryptionService):
    ...
    def test_no_plaintext_in_error_messages(self, encryption_service: CredentialEncryptionService):
...
class TestSettingsIntegration:
    ...
    def test_service_handles_missing_settings(self):
        ...
        with patch("omoi_os.services.credential_encryption.get_app_settings") as mock_get:
            mock_settings = MagicMock()
