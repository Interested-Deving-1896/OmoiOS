...
**Related Documents:**
- [Main Design Document](../frontend/project_management_dashboard.md) - UI/UX design and user flows
- [Implementation Details](../../implementation/frontend/project_management_dashboard_implementation.md) - Code examples and technical implementation
...
See [Main Design Document - Existing Codebase Mapping](../frontend/project_management_dashboard.md) for complete list of implemented endpoints.
...
See [Main Design Document](../frontend/project_management_dashboard.md) for usage details.
...
See [Main Design Document - WebSocket Integration](../frontend/project_management_dashboard.md) for connection details.
...
See [Main Design Document - Next Steps](../frontend/project_management_dashboard.md) for implementation priorities.
