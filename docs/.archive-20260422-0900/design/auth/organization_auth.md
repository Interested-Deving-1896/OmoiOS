...
**Related**: docs/design/auth/api_key_design.md (TODO: Create stub), docs/design/auth/rbac_design.md (TODO: Create stub), docs/architecture/auth/adr_auth_system.md (TODO: Create stub)
